...
import { KIT, QUESTIONS, GUIDE_STATS, SEND_HISTORY } from './data/guide.js'
...
export default function GuideScreen() {
  const t = kaB2B
  const g = t.guide
  /* q is lifted above GuideLibrary so a history row can seed the search. */
  ...
  return (
    <>
      ...
      <GuideLibrary id={LIB_ID} q={q} onQueryChange={setQ} onSend={sendMaterial} />
