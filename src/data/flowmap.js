  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        status: 'in-progress',
        flows: [
          { id: 'dCur',     path: 'dash/curatio',          label: 'section — doctor · records', status: 'in-progress', hash: '/dash/curatio' },
      ...
      {
        id: 'visa-benefit',
        label: 'Visa campaign — post-payment benefit claim',
        status: 'in-progress',
        flows: [
          { id: 'dVisa',   path: 'dash/visa-benefit',            label: 'tracker → strip → claim card (v2)', status: 'in-progress', hash: '/dash/visa-benefit' },
          { id: 'dVisaNo', path: 'dash/visa-benefit?eligible=0', label: '↳ not eligible — receipt only',      status: 'in-progress', hash: '/dash/visa-benefit?eligible=0' },
          { id: 'dVisaPk', path: 'dash/visa-benefit?reward=perks', label: '↳ reward = perks (instead of points)', status: 'in-progress', hash: '/dash/visa-benefit?reward=perks' },
          { id: 'dVisaV1', path: 'dash/visa-benefit?v=1',        label: '↳ v1 parked — receipt-first (compare)', status: 'planned',     hash: '/dash/visa-benefit?v=1' },
        ],
      },
    ],
  },
