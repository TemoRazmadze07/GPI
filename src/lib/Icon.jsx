/* Icon — stroke-only Lucide glyphs, mirroring the Figma Icon component.
   Colour follows currentColor; size in px. Stroke width tuned per size. */
